...
const AI_RESPONSES: Record<string, string> = {
  ...
  default: "🧠 I'm Global Signal's AI assistant. I can help you understand world data, analyze trends, and provide insights across all data categories — weather, earthquakes, markets, health, space, energy, and more. What would you like to know?",
};
...
function getAIResponse(query: string): string {
  ...
  if (q.includes("hello") || q.includes("hi") || q.includes("hey")) {
    return "👋 Hello! I'm Global Signal AI. I can help you analyze world data, spot trends, and generate insights. Ask me anything about global metrics!";
  }
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setMessages([{
        id: "welcome",
        role: "ai",
        content: "👋 Welcome to **Global Signal AI**! I can analyze real-time world data, detect anomalies, and provide intelligent insights. Ask me anything!",
        timestamp: new Date(),
      }]);
    }
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="border-t px-5 py-4" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
                ...
                <div className="mt-2 flex items-center justify-between text-[9px]" style={{ color: "rgba(255,255,255,0.2)" }}>
                  <span>Powered by Global Signal Intelligence</span>
